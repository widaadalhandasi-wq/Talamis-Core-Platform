        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TranscriptContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Duration = table.Column<TimeSpan>(type: "time", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioContents", x => x.AudioId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelAudioUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DifficultyLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyPrompts", x => x.PromptId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSubmissions_DailyPrompts_PromptId",
                        column: x => x.PromptId,
                        principalTable: "DailyPrompts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AudioContents_Category",
                table: "AudioContents",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_DailyPrompts_TargetDate",
                table: "DailyPrompts",
                column: "TargetDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubmissions_PromptId",
