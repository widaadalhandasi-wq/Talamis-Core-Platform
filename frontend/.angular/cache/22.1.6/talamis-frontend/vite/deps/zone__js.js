...
function loadZone() {
	...
	(_global$Zone = global["Zone"]) !== null && _global$Zone !== void 0 || (global["Zone"] = initZone());
	return global["Zone"];
}
/**
	...
	function patchEventTargetMethods(obj, patchOptions) {
		...
		*/
		function buildEventListenerOptions(options, passive) {
			...
			if (typeof options === "object" && options.passive !== false) return _objectSpread2(_objectSpread2({}, options), {}, { passive: true });
			return options;
		}
		...
		*/
		...
		function copyEventListenerOptions(options) {
			if (typeof options === "object" && options !== null) {
				const newOptions = _objectSpread2({}, options);
...
function propertyDescriptorPatch(api, _global) {
	...
	for (let i = 0; i < patchTargets.length; i++) {
		...
		!(target === null || target === void 0) && target.prototype && patchFilteredProperties(target.prototype, getOnEventNames(target.prototype), ignoreProperties);
	}
}
/**
* @fileoverview
